insert into tasks (command,                                        description,                                      enabled, beanName,     name,               groupName, priority,timerSchedule,  version, errorIfRunning, stopOnError, notifyOnSuccess, notifyOnFailure) 
